"""
Extension — Preprocessing for Keyboards & MIDI Reviews
=======================================================
Mirrors lda_guitars_v2.py stages 1-2.
Run this FIRST. Saves tokens/dict/corpus for tune_params_keyboards.py and assign_topics_keyboards.py.

Output: keyboards_tokens.pkl, keyboards_dict.pkl, keyboards_corpus.pkl
"""
...
TOKENS_OUT  = os.path.join(SCRIPT_DIR, 'keyboards_tokens.pkl')
DICT_OUT    = os.path.join(SCRIPT_DIR, 'keyboards_dict.pkl')
CORPUS_OUT  = os.path.join(SCRIPT_DIR, 'keyboards_corpus.pkl')
...
if stage_done(TOKENS_OUT):
    ...
    # 'keyboard'/'piano'/'midi' appear in virtually every review → no topic signal.
    custom_stops = {
        'keyboard', 'keyboards', 'piano', 'pianos', 'midi',
        'synthesizer', 'synth', 'synths',
...
print("\nDone.")
print("Next: sbatch run_tune_keyboards.sh")
