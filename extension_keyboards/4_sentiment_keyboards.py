"""
RoBERTa Sentiment Fine-tuning — Keyboards & MIDI Reviews
=========================================================
...
DATA_FILE  = os.path.join(NLP_DIR, 'keyboards_with_topics.parquet')
...
# ── Argument parser ───────────────────────────────────────────────────────────
parser = argparse.ArgumentParser(description="Fine-tune RoBERTa for keyboards sentiment analysis")
parser.add_argument("--data",       type=str,   default=DATA_FILE)
parser.add_argument("--model",      type=str,   default="roberta-base")
parser.add_argument("--output_dir", type=str,   default=os.path.join(SCRIPT_DIR, "roberta_keyboards_model"))
...
inference_df.to_csv(os.path.join(SCRIPT_DIR, "keyboards_bert_predictions.csv"), index=False)
topic_sentiment.to_csv(os.path.join(SCRIPT_DIR, "keyboards_bert_topic_sentiment.csv"))
print("\nSaved: keyboards_bert_predictions.csv")
print("Saved: keyboards_bert_topic_sentiment.csv")
print("\nDone!")
